...
int QT_RCC_MANGLE_NAMESPACE(qInitResources_appLogAnalizer_raw_qml_0)();
int QT_RCC_MANGLE_NAMESPACE(qInitResources_appLogAnalizer_raw_qml_0)()
{
    int version = 3;
...
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_appLogAnalizer_raw_qml_0)();
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_appLogAnalizer_raw_qml_0)()
{
    int version = 3;
...
namespace {
   struct initializer {
       initializer() { QT_RCC_MANGLE_NAMESPACE(qInitResources_appLogAnalizer_raw_qml_0)(); }
       ~initializer() { QT_RCC_MANGLE_NAMESPACE(qCleanupResources_appLogAnalizer_raw_qml_0)(); }
   } dummy;
}
