...
#include "../../../src/cpp_code/log/logmanager.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSLogManagerENDCLASS_t qt_meta_stringdata_CLASSLogManagerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 19),  // "getGameplayShortcut"
        QT_MOC_LITERAL(31, 0),  // ""
        QT_MOC_LITERAL(32, 20),  // "getGameplayLogsTitle"
        QT_MOC_LITERAL(53, 8)   // "type_str"
    },
    "LogManager",
    "getGameplayShortcut",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLogManagerENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       3,    1,   27,    2, 0x10a,    2 /* Public | MethodIsConst  */,
...
void LogManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: { QJsonArray _r = _t->getGameplayShortcut();
            if (_a[0]) *reinterpret_cast< QJsonArray*>(_a[0]) = std::move(_r); }  break;
        case 1: { QJsonArray _r = _t->getGameplayLogsTitle((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< QJsonArray*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
